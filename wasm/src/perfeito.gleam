...
pub fn perfeito_examples() {
  ...
  // 6 = 1 + 2 + 3
  eq(perfeito(6), True)
  eq(perfeito(27), False)
  // 28 = 1 + 2 + 4 + 7 + 14
  eq(perfeito(28), True)
  eq(perfeito(29), False)
}

pub fn soma_divisores_examples() {
  eq(soma_divisores(7, 1), 1)
  eq(soma_divisores(7, 0), 0)
  // 4 + 2 + 1
  eq(soma_divisores(4, 4), 7)
  // 5 + 2 + 1
  eq(soma_divisores(10, 9), 8)
}
