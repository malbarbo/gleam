...
pub fn calcula_imposto_examples() {
  eq(calcula_imposto(900.0), 45.0)
  eq(calcula_imposto(1000.0), 50.0)
  eq(calcula_imposto(3000.0), 250.0)
  eq(calcula_imposto(5000.0), 450.0)
  eq(calcula_imposto(10_000.0), 1450.0)
}
