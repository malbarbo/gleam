...
pub fn dentro_janela_examples() {
  ...
  // p1 - dentro da janela
  eq(dentro_janela(jj, Clique(x: 150, y: 150)), True)
  // p2 - dentro do espaço da altura e depois do espaço da largura
  eq(dentro_janela(jj, Clique(x: 600, y: 150)), False)
  // p3 - depois do espaço da altura e dentro do espaço da largura
  eq(dentro_janela(jj, Clique(x: 150, y: 300)), False)
  // p4 - dentro do espaço da altura e antes do espaço da largura
  eq(dentro_janela(jj, Clique(x: 150, y: 50)), False)
  // p5 - antes do espaço da altura e dentro do espaço da largura
  eq(dentro_janela(jj, Clique(x: 150, y: 50)), False)
  // canto superior esquerdo
  eq(dentro_janela(jj, Clique(x: 100, y: 100)), True)
  // canto superior direito
  eq(dentro_janela(jj, Clique(x: 399, y: 100)), True)
  eq(dentro_janela(jj, Clique(x: 400, y: 100)), False)
  // canto inferior direito
  eq(dentro_janela(jj, Clique(x: 399, y: 299)), True)
  eq(dentro_janela(jj, Clique(x: 400, y: 299)), False)
  eq(dentro_janela(jj, Clique(x: 399, y: 300)), False)
  eq(dentro_janela(jj, Clique(x: 400, y: 300)), False)
  // canto inferior esquerdo
  eq(dentro_janela(jj, Clique(x: 100, y: 299)), True)
  eq(dentro_janela(jj, Clique(x: 100, y: 300)), False)
}
...
pub fn main() {
  dentro_janela_examples()
  janelas_sobrepoem_examples()
}
