...
pub fn novo_salario_examples() {
  // salario_atual <= 1200
  eq(novo_salario(1000.0), 1100.0)
  eq(novo_salario(1200.0), 1320.0)

  // salario_atual <= 3000
  eq(novo_salario(2000.0), 2140.0)
  eq(novo_salario(3000.0), 3210.0)

  // salario_atual <= 8000
  eq(novo_salario(5000.0), 5150.0)
  eq(novo_salario(8000.0), 8240.0)

  // salario_atual > 8000
  eq(novo_salario(8000.01), 8000.01)
}
