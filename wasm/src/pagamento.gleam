...
pub fn valor_final_compra_examples() {
  eq(valor_final_compra(100.0, Dinheiro), 100.0 *. 0.9)
  eq(valor_final_compra(200.0, Pix), 200.0 *. 0.9)
  eq(valor_final_compra(300.0, Boleto), 300.0 *. 0.95)
  eq(valor_final_compra(100.0, Cartao(1)), 100.0)
  eq(valor_final_compra(100.0, Cartao(3)), 100.0)
  eq(valor_final_compra(200.0, Cartao(4)), 200.0 *. 1.15)
}
