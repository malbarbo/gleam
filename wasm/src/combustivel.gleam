...
pub fn seleciona_combustivel_examples() {
  eq(seleciona_combustivel(preco_(3.0), preco_(4.0)), Gasolina)
  eq(seleciona_combustivel(preco_(2.9), preco_(4.2)), Alcool)
  eq(seleciona_combustivel(preco_(3.5), preco_(5.0)), Alcool)
}
...
pub fn main() {
  seleciona_combustivel_examples()
}
