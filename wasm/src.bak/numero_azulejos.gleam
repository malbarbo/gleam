...
pub fn numero_azulejos_examples() {
  ...
  eq(numero_azulejos(2.0, 2.4), 120)
  // com recortes
  // 8 (ceiling (/ 1.5 0.2)) x 12 (ceiling (/ 2.3 0.2))
  eq(numero_azulejos(1.5, 2.3), 96)
  // Situações particulares
  eq(numero_azulejos(0.2, 0.2), 1)
  eq(numero_azulejos(0.3, 0.2), 2)
  eq(numero_azulejos(0.3, 0.3), 4)
  eq(numero_azulejos(0.4, 0.4), 4)
}
