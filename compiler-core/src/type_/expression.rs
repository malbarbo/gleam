...
pub struct Implementations {
    ...
    pub can_run_on_webassembly: bool,
    ...
    /// Whether the function has an implementation that uses external webassembly
    /// code.
    pub uses_webassembly_externals: bool,
}
...
pub struct FunctionDefinition {
    ...
    /// The function has @external(WebAssembly, "...", "...")
    pub has_webassembly_external: bool,
}
...
impl FunctionDefinition {
    pub fn has_external_for_target(&self, target: Target) -> bool {
        match target {
            ...
            Target::WebAssembly => self.has_webassembly_external,
        }
    }
}
...
impl Implementations {
    ...
    pub fn update_from_use(
        ...
        let Implementations {
            ...
            uses_webassembly_externals: other_uses_webassembly_externals,
            can_run_on_erlang: other_can_run_on_erlang,
            can_run_on_javascript: other_can_run_on_javascript,
            can_run_on_webassembly: other_can_run_on_webassembly,
        } = implementations;
        let FunctionDefinition {
            has_body: _,
            has_erlang_external,
            has_javascript_external,
            has_webassembly_external,
        ...
        self.can_run_on_webassembly = *has_webassembly_external
            || (self.can_run_on_webassembly && (*gleam || *other_can_run_on_webassembly));
        ...
        self.uses_webassembly_externals =
            self.uses_webassembly_externals || *other_uses_webassembly_externals;
    }
    ...
    pub fn supports(&self, target: Target) -> bool {
        self.gleam
            || match target {
                ...
                Target::WebAssembly => self.can_run_on_webassembly,
            }
    }
}
...
impl<'a, 'b> ExprTyper<'a, 'b> {
    pub fn new(
        ...
        let implementations = Implementations {
            ...
            can_run_on_webassembly: definition.has_body || definition.has_webassembly_external,
            uses_erlang_externals: definition.has_erlang_external,
            uses_javascript_externals: definition.has_javascript_external,
            uses_webassembly_externals: definition.has_webassembly_external,
        };
        ...
        let uses_externals = match environment.target {
            ...
            Target::WebAssembly => implementations.uses_webassembly_externals,
        };
